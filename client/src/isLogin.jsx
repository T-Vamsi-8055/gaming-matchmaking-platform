      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-between p-8 sm:p-12 md:p-20 bg-zinc-950 border-r border-zinc-800/50 z-10">
        ...
        <div className="w-full max-w-md mx-auto my-auto py-8">
          ...
          <p className="text-sm text-zinc-400 mb-8">
            {isLogin ? 'The queue is waiting. Ready up.' : 'Join thousands of players looking for a squad.'}
          </p>
          ...
          <div className="grid grid-cols-2 bg-zinc-900 p-1 rounded-lg mb-6 border border-zinc-800">
            <button 
              ...
              className={`py-2 text-sm font-semibold rounded-md transition-all ${isLogin ? 'bg-zinc-800 text-cyan-400 shadow-sm' : 'text-zinc-400 hover:text-zinc-200'}`}
            >
              Sign In
            </button>
            <button 
          ...
          {error && <p className="text-xs font-semibold text-red-500 bg-red-500/10 border border-red-500/20 p-3 rounded mb-4 uppercase tracking-wider">{error}</p>}
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                {isLogin && <a href="#" className="text-xs text-cyan-500 hover:underline">Forgot?</a>}
              </div>
              <input 
                type="password" 
                name="password"
